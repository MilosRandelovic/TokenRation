...
public struct ProviderUsage: Codable, Sendable {
    ...
    public init(provider: String, displayName: String, status: String, error: String?,
                updatedAt: Date?, rateLimitedUntil: Date?, metrics: [MetricUsage]) {
...
public struct MetricUsage: Codable, Sendable {
    ...
    public init(id: String, title: String, usedPercent: Double?, value: String, detail: String,
                severity: String, resetsAt: Date?) {
        self.id = id
        self.title = title
...
public extension ProviderUsage {
    ...
    func readingAge(now: Date = Date()) -> TimeInterval? {
...
public enum UsageStateStore {
    public static var fileURL: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Application Support/TokenRation/usage.json")
    }
