...
/// Short "1h 19m"-style countdown, shared by the menu-bar icon and the popover so they
/// always agree (the popover used to round to a single "1 hr" unit via RelativeDateTimeFormatter).
enum ResetText {
